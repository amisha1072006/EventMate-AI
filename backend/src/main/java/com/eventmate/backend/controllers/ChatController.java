...
public class ChatController {
    ...
    /**
     * EventMate Bot से प्रश्न पूछने के लिए नया एंडपॉइंट (Endpoint)
     * Request Body: {"query": "Hall.java ka kya kaam hai?"}
     */
    @PostMapping("/ask")
    public Map<String, String> askBot(@RequestBody Map<String, String> request) {
        String question = request.get("query");
        String answer = knowledgeService.getAnswer(question);
