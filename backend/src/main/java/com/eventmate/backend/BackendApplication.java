...
public class BackendApplication {
    ...
    public CommandLineRunner initDatabase(
        ...
        return args -> {
            ...
            System.out.println("--- [DATABASE INIT] Starting Database Initialization(V5 Update/Create Mode) ---");
            
            // --- 1. HALL DATA INITIALIZATION ---
            if(hallRepository.count() == 0){
            System.out.println("[DB INIT] Populating Hall data...");
            ...
            System.out.println("[DB INIT] Hall data populated.");
                            ...
                            System.out.println("[DB INIT] Hall data already exists.Skipping hall population.");

            }
            // --- 2. PLANNER DATA INITIALIZATION (Corrected Data) ---
            System.out.println("[DB INIT] Updating/Creating Planner data...");
            
            
            // Planner 1: Priya Singh (Data from your screenshots)
            //Planner p1 = new Planner();
            Planner p1 = plannerRepository.findByNameContainingIgnoreCase("Priya Singh").orElse(new Planner());
            p1.setName("Priya Singh");
            p1.setStartingPrice(15000.00); // 💥 फिक्स: ₹15,000 (प्रोफाइल इमेज के अनुसार)
            p1.setRating(4.9);
            p1.setSpecialization("Specializes in luxury weddings, corporate events, and bday parties."); // 💥 फिक्स: पूरा टेक्स्ट
            ...
            // Planner 2: Rajesh Kumar (Data from your screenshots)
            //Planner p2 = new Planner();
            Planner p2 = plannerRepository.findByNameContainingIgnoreCase("Rajesh Kumar").orElse(new Planner());
            p2.setName("Rajesh Kumar");
            p2.setStartingPrice(10000.00); // 💥 फिक्स: ₹10,000 (प्रोफाइल इमेज के अनुसार)
            p2.setRating(4.7);
            p2.setSpecialization("Known for destination weddings, Engagement and corporate events."); // 💥 फिक्स: पूरा टेक्स्ट
            ...
            // Planner 3: Himanshu Sharma (Data from your screenshots)
            //Planner p3 = new Planner();
            Planner p3 = plannerRepository.findByNameContainingIgnoreCase("Himanshu Sharma").orElse(new Planner());
            p3.setName("Himanshu Sharma");
            p3.setStartingPrice(20000.00);
            p3.setRating(4.8);
            p3.setSpecialization("Specializes in Engagement, Bday and luxury Wedding"); // 💥 फिक्स: 'luxary' -> 'luxury'
            ...
            // Planner 4: Aakash Pandey (Data from your screenshots)
           // Planner p4 = new Planner();
           Planner p4 = plannerRepository.findByNameContainingIgnoreCase("Aakash Pandey").orElse(new Planner());
            ...
            System.out.println("[DB INIT] Planner data updated/created");
            ...
            // 💥 फिक्स: वेरिएबल का नाम (p1) से (ph1) किया गया
            ...
            photographerRepository.save(ph1); // 💥 फिक्स: p1 -> ph1

            // --- Photographer 2: Rajesh Photography ---
            Photographer ph2 = new Photographer(); // 💥 फिक्स: वेरिएबल का नाम (p2) से (ph2) किया गया
            ...
            photographerRepository.save(ph2); // 💥 फिक्स: p2 -> ph2

            // --- Photographer 3: Chandan Photography ---
            Photographer ph3 = new Photographer(); // 💥 फिक्स: वेरिएबल का नाम (p3) से (ph3) किया गया
            ...
            photographerRepository.save(ph3); // 💥 फिक्स: p3 -> ph3

            // --- Photographer 4: Aashutosh Photography ---
            Photographer ph4 = new Photographer(); // 💥 फिक्स: वेरिएबल का नाम (p4) से (ph4) किया गया
            ...
            photographerRepository.save(ph4); // 💥 फिक्स: p4 -> ph4

            System.out.println("Photographer data populated.");
            } else {
            
            System.out.println("--- [DATABASE INIT] Photographer data already exists. Skipping photographer population.");
            }
            System.out.println("---[DATABASE INIT] Database Initialization Finished ---");
            
        }; // 💥 फिक्स: यह lambda (->) को बंद करता है
    } // 💥 फिक्स: यह initDatabase() मेथड को बंद करता है
} // 💥 फिक्स: यह BackendApplication क्लास को बंद करता है
...
//                 p1.setRating(4.9);
//                 p1.setSpecialization("Luxury weddings,corporate events,and bday parties");
...
//                 p2.setRating(4.7);
//                 p2.setSpecialization("Destination Weddings,Engagement and corporate events");
...
//                 p3.setStartingPrice(20000.00);
//                 p3.setRating(4.8);
//                 p3.setSpecialization("Specializes in Engagement,Bday and luxary Wedding");
//                 p3.setImageLink("https://media.istockphoto.com/id/1412021265/photo/head-shot-portrait-smiling-bearded-man-looking-at-camera.jpg?s=2048x2048&w=is&k=20&c=M4dFUZwVsUEUfLi5ixFjubRgx2ly-QxV5llizOAz3rs="); // Profile photo
//                 p3.setContact("+919044974477");
//                 plannerRepository.save(p3);
...
//                 p4.setRating(4.6);
//                 p4.setSpecialization("Specializes in all types of events and parties like -Destination Weddings,Engagement,bday parties and corporate events");
//                 p4.setImageLink("https://media.istockphoto.com/id/1459185149/photo/portrait-of-young-man-shaking-head-as-yes-sign-approval.jpg?s=1024x1024&w=is&k=20&c=5bvev5LhMOH7ZCUO3jnPPCVkc0RwnMppRV0ncZZAW4Q="); // Profile photo
//                 p4.setContact("+919045984170");
//                 plannerRepository.save(p4);
...
//                 p3.setImageLink("/images/photographer6.jpg"); 
